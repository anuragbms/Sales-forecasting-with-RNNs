...
DATAFILE_VALIDATE = 'mock_kaggle_edit_validate+309.csv'

TRAINED_MODEL_PATH = 'Model4'
...
validationData_sales = data_validate['sales_same'][0:numValidationData]
...
with tf.Session() as sess:
    ...
    startLoc = 0
    totalLoss = 0
    for i in range(1, len(validationDataSequence_sales) // BATCH_SIZE):
